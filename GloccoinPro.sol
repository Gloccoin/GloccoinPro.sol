...
/**
   #Gloccoin Pro(GLOCP)
   15% fee auto add to the liquidity pool
   5% distribute to a charity wallet
   25% to holders
...
contract GloccoinPro is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0xc391C8362670b263eb1bC7966A3973f334CDEf89;
    ...
    string private _name = "Gloccoin PRO";
    string private _symbol = "GLOCP";
